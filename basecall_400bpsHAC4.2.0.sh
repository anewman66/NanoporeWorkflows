...
echo "--- Output file will be named "$2"_400bpsHAC4.1.0.bam"

if [ ! -f ./"$2_400bpsHAC4.1.0.bam" ] ; 
...
touch "$2"_400bpsHAC4.1.0.bam

dorado basecaller --verbose models/dna_r10.4.1_e8.2_400bps_hac@v4.1.0 $1 > "$2"_400bpsHAC4.1.0.bam
